...
export default function SignupPage() {
  ...
  async function handleSignup() {
    ...
    try {
      ...
      if (result?.error) throw new Error("Signup succeeded, but auto-login failed. Please log in.");
  ...
  return (
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <p style={s.subtitle}>Save your resumes and skill analyses to come back to anytime.</p>
